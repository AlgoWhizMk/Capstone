    ...
    <>
      ...
      <nav className={`skw-nav ${scrolled ? "skw-nav-scrolled" : ""}`}>
        ...
        <div className="skw-nav-actions">
          <Link to="/cart" className="skw-cart-btn" aria-label="Cart">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/>
              <path d="M1 1h4l2.68 13.39a2 2 0 001.98 1.61h9.72a2 2 0 001.98-1.61L23 6H6"/>
            </svg>
            {cartCount > 0 && <span className="skw-cart-badge">{cartCount}</span>}
          </Link>
        ...
        {menuOpen && (
          <div className="skw-mobile-menu">
            ...
            <div className="skw-mobile-actions">
              <Link to="/cart" className="skw-mobile-link" onClick={() => setMenuOpen(false)}>
                🛒 Cart ({cartCount})
              </Link>
              {user ? (
                <>
